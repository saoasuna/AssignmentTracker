...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://saoasuna.advancedtodo.provider/messages");
    public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://saoasuna.advancedtodo.provider/profile");
    ...
    static {
        ...
        uriMatcher.addURI("saoasuna.advancedtodo.provider", "messages", MESSAGES_ALLROWS);
        uriMatcher.addURI("saoasuna.advancedtodo.provider", "messages/#", MESSAGES_SINGLE_ROW);
        uriMatcher.addURI("saoasuna.advancedtodo.provider", "profile", PROFILE_ALLROWS);
        uriMatcher.addURI("saoasuna.advancedtodo.provider", "profile/#", PROFILE_SINGLE_ROW);
    }
